...
public class HttpRequestTelescoping {
    private static final Logger logger = LoggerFactory.getLogger(HttpRequestTelescoping.class);
    ...
    public HttpRequestTelescoping(String url, String method, Map<String, String> headers,
        ...
        logger.info("HttpRequest Created: URL={},  Method={}, Headers={}, Params={},  Body={}, Timeout={} ",url, method, this.headers.size(), this.queryParams.size(), (body != null), timeout);
    }
}
